import 'package:event_hub/features/filter/presentation/cubit/filter_cubit.dart';
  ...
  static Future<String?> show(BuildContext context) {
    return showModalBottomSheet<String?>(
      ...
      builder: (_) => BlocProvider(
        create: (context) => FilterCubit(context.read<TicketmasterRepository>()),
              ...
              child: Column(
                ...
                children: [
                    ...
                    SizedBox(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (_, i) => FilterCategoryButton(
                          ...
                          onTap: () => context.read<FilterCubit>().selectCategory(i),
                        ),
                      ),
                    ),
                    ...
                    children: List.generate(
                      ...
                      (i) => Padding(
                        ...
                        child: FilterTimeChip(
                          label: _timeLabels[i],
                          isSelected: state.selectedTime == i,
                          onTap: () => context.read<FilterCubit>().selectTime(i),
                        ),
                      ),
                    ),
                  ),
                  ...
                  RangeSlider(
                    ...
                    onChanged: (v) => context.read<FilterCubit>().setPriceRange(v),
                  ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () {
                            final classificationId = context.read<FilterCubit>().getSelectedClassificationId();
                            Navigator.pop(context, classificationId);
                          },
